...
class TelaInicialActivity : DebugActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    fun enviaNotificacao(disciplina: Disciplina) {
        ...
        NotificationUtil.create(this, 1, intent, "LMSApp", "Você tem nova atividade na ${disciplina.name}")
    }

    // tratamento do evento de clicar em uma disciplina
    fun onClickDisciplina(disciplina: Disciplina) {
        Toast.makeText(context, "Clicou disciplina ${disciplina.name}", Toast.LENGTH_SHORT).show()
