...
object DisciplinaService {
    ...
    val host = "https://ninjatech-ope.herokuapp.com"
    val TAG = "WS_LMSApp"

    fun getDisciplinas(context: Context): List<Disciplina> {
        var disciplinas = ArrayList<Disciplina>()
        if (br.com.pabloferreira.lmsapp.AndroidUtils.isInternetDisponivel()) {
            val url = "$host/api/activities-public/"
            ...
            val dao = br.com.pabloferreira.lmsapp.DatabaseManager.getDisciplinaDAO()
